...
//app = express();
const MONGO_URI = 'mongodb+srv://admin:admin@cluster0.olpwll4.mongodb.net/week8';
...
const doc1 = new person_doc({ name: 'Samir',age:21,Gender:"Male",Salary:3456 }
);
...
doc1
 ...
 manypersons=[{ name: 'Simon',age:22,Gender:"Male",Salary:3456 }
 ,{ name: 'Neesha',age:22,Gender:"Female",Salary:1000 }
 ,{ name: 'Mary',age:18,Gender:"Female",Salary:5402 },
 { name: 'Mike',age:20,Gender:"Male",Salary:4519 }
 ]
